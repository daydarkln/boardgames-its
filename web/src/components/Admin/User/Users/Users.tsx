      ...
      <table className="rw-table">
        <thead>
          <tr>
            ...
            <th>District</th>
            <th>Bio</th>
            <th>Favorite directions</th>
            <th>Favorite games text</th>
        ...
        <tbody>
          {users.map((user) => (
            <tr key={user.id}>
              ...
              <td>{formatEnum(user.favoriteDirections)}</td>
              <td>{truncate(user.favoriteGamesText)}</td>
              <td>{formatEnum(user.experienceLevel)}</td>
